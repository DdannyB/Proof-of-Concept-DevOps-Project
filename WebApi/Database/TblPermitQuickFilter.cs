...
{
    public partial class TblPermitQuickFilter
    {
        public TblPermitQuickFilter()
        {
            TblBasePermitItemPartPermitQuickFilter = new HashSet<TblBasePermitItemPartPermitQuickFilter>();
        }

        public long PkPermitquickfilterid { get; set; }
        public string Permitquickfiltername { get; set; }
